...
def _get_package_config_settings_path() -> Path:
    """
    Returns the path to the package config settings file.
    """
    return Path(__file__).parent / "config_settings.yaml"


def _get_local_config_settings_path() -> Path:
    """
...
def _copy_package_config_settings_to_local():
    ...
    """
    package_config_path = _get_package_config_settings_path()
    local_config_path = _get_local_config_settings_path()
...
PACKAGE_CONFIG_SETTINGS_PATH = _get_package_config_settings_path()
LOCAL_CONFIG_SETTINGS_PATH = _get_local_config_settings_path()
