...
class OCIOConfig:
    def __init__(self, config_data=None, config_path=None, output_dir=None):
        ...
        # self.roles = yaml_data.get('roles', {}) # Load roles from YAML, default to empty dict # Now handled above
        ...
        # self.active_colorspaces = yaml_data.get('active_colorspaces') # Now handled above
        ...
        # Covers linear range of ~-0.006 to ~256 w/ 0.18 -> ~0.35
        # https://www.desmos.com/calculator/p3mpjti9lw
